...
//-----------------------------------------------------------------------------
class DLLIMPEXP CSSNodeRecorder : public CSSRecorder {

public:
	ACRX_DECLARE_MEMBERS(CSSNodeRecorder) ;
...
public:
	CSSNodeRecorder () ;
	CSSNodeRecorder (int objTag, int dof, std::string path, int dataCol, bool hasTime) ;
	virtual ~CSSNodeRecorder () ;
...
#ifdef CADSEESOBJECTS_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(CSSNodeRecorder)
#endif
