...
ACRX_DXF_DEFINE_MEMBERS (
	CSSDispBeamColumn, CSSLineElement,
	AcDb::kDHL_CURRENT, AcDb::kMReleaseCurrent, 
	AcDbProxyEntity::kNoOperation, CSSDISPBEAMCOLUMN,
CADSees
...
//-----------------------------------------------------------------------------
CSSDispBeamColumn::CSSDispBeamColumn () : CSSLineElement () {
	m_type = AcString(_T("dispBeamColumn"));
}

CSSDispBeamColumn::CSSDispBeamColumn(int tag, int inode, int jnode, int nIntegPnts): CSSLineElement (tag, inode, jnode, nIntegPnts, "dispBeamColumn")
{
}
...
Adesk::Boolean CSSDispBeamColumn::subWorldDraw (AcGiWorldDraw *mode) {
	assertReadEnabled () ;
	return (CSSLineElement::subWorldDraw (mode)) ;
}


Adesk::UInt32 CSSDispBeamColumn::subSetAttributes (AcGiDrawableTraits *traits) {
	assertReadEnabled () ;
	return (CSSLineElement::subSetAttributes (traits)) ;
}

	//- Osnap points protocol
Acad::ErrorStatus CSSDispBeamColumn::subGetOsnapPoints (
...
Acad::ErrorStatus CSSDispBeamColumn::subGetGripPoints (
...
Acad::ErrorStatus CSSDispBeamColumn::subMoveGripPointsAt (const AcDbIntArray &indices, const AcGeVector3d &offset) {
	assertWriteEnabled () ;
	//----- This method is never called unless you return eNotImplemented 
...
Acad::ErrorStatus CSSDispBeamColumn::subMoveGripPointsAt (
