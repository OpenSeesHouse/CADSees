...
//-----------------------------------------------------------------------------
//----- CSSLineElement.h : Declaration of the CSSLineElement
//-----------------------------------------------------------------------------
#pragma once
...
//-----------------------------------------------------------------------------
class DLLIMPEXP CSSLineElement : public CSSElement {

public:
	ACRX_DECLARE_MEMBERS(CSSLineElement) ;
protected:
...
#ifdef CADSEESOBJECTS_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(CSSLineElement)
#endif
