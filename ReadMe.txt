...
Welcome! and thank you for your interest in the CADSess application!

CADSess is an OpenSes pre/post-processor designed for AutoCAD application.
...
4-Currently, outputs are created in folder: C:\Program files\CADSess. Since this folder is placed in C:\ drive,
...
5-Since CADSess project depends on the outputs of the CSSObjects project, you have to first build this project.
...
6-After successful building of the projects, run "CADSees_reg-2021.reg" placed in the root of the repository to
 ...
 created in "C:\Program files\CADSess" folder.
...
8-After running AutoCAD, create a new drawing and run the "importOPS" command. At the first time, the toolbar placed
 in the "C:\Program files\CADSess" will be added to the environment and you can invoke the commands from this toolbar
 in future runs. If CADSess is loaded successfully, you will see the start screen with the "CivilSoftScience" logo.
